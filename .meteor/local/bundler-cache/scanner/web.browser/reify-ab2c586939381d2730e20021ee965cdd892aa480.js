module.export({elementIsOrContains:()=>elementIsOrContains,throttleEvent:()=>throttleEvent,throttleReactEventCallback:()=>throttleReactEventCallback,throttle:()=>throttle});/*
