module.export({Portal:()=>Portal});let __extends;module.link("tslib",{__extends(v){__extends=v}},0);let React;module.link("react",{"*"(v){React=v}},1);let ReactDOM;module.link("react-dom",{"*"(v){ReactDOM=v}},2);let Classes;module.link("../../common/classes",{"*"(v){Classes=v}},3);let Errors;module.link("../../common/errors",{"*"(v){Errors=v}},4);let DISPLAYNAME_PREFIX;module.link("../../common/props",{DISPLAYNAME_PREFIX(v){DISPLAYNAME_PREFIX=v}},5);let isFunction;module.link("../../common/utils",{isFunction(v){isFunction=v}},6);/*
