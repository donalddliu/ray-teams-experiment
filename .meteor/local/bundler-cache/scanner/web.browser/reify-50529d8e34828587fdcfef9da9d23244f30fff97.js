module.export({useHotkeys:()=>useHotkeys});let __spreadArray;module.link("tslib",{__spreadArray(v){__spreadArray=v}},0);let React;module.link("react",{"*"(v){React=v}},1);let comboMatches,getKeyCombo,parseKeyCombo;module.link("../../components/hotkeys/hotkeyParser",{comboMatches(v){comboMatches=v},getKeyCombo(v){getKeyCombo=v},parseKeyCombo(v){parseKeyCombo=v}},2);let HotkeysContext;module.link("../../context",{HotkeysContext(v){HotkeysContext=v}},3);/*
