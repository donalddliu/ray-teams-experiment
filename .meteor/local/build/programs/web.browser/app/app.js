...
const RaceQuestionSet = (_ref6) => {
  ...
  const options = ["African American or Black", "Asian", "Hispanic", "White", "Multiracial or biracial", "Other"];
...
const EducationQuestionSet = (_ref8) => {
  let {
    selected,
    textValue,
    handleEducationChange
  } = _ref8;
  const options = ["High school graduate", "Bachelor's degree", "Master's degree or higher", "Other"];
...
const EmploymentQuestionSet = (_ref9) => {
  let {
    selected,
...
const JobTitleQuestionSet = (_ref10) => {
  let {
    textValue,
...
class NetworkSurveyRelationshipInterpreter extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "network-form",
      onSubmit: this.handleSubmit
    }, /*#__PURE__*/React.createElement("p", null, " What is their relationship to you? (Select all that apply) "), names.map((name, i) => {
